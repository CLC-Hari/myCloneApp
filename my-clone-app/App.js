  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        {[ 
          { id: 1, title: "Winter 2025 Mobile Application Development (CPRG-303-E)", code: "202430 CPRG-303-E" },
          { id: 2, title: "Title", code: "Code" },
          { id: 3, title: "Title", code: "Code" }
        ].map(course => (
          <View key={course.id} style={styles.courseCard}>
            <Image source={require('./assets/course-bg.png')} style={styles.courseImage} />
            <View style={styles.courseTextContainer}>
              <Text style={styles.courseTitle}>{course.title}</Text>
              <Text style={styles.courseSubtitle}>{course.code} • Winter 2025</Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  navbar: { flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 20, marginBottom: 10 },
  time: { fontSize: 18 },
  rightIcons: { flexDirection: 'row', gap: 10 },
  title: { fontSize: 20, fontWeight: 'bold', textAlign: 'center' },
  homeButton: { backgroundColor: '#ddd', padding: 10, marginHorizontal: 20, borderRadius: 5, alignItems: 'center', marginVertical: 10 },
  homeButtonText: { fontSize: 16, fontWeight: '500' },
  scrollView: { flex: 1 },
  courseCard: { backgroundColor: '#fff', borderRadius: 10, marginHorizontal: 20, marginBottom: 15, overflow: 'hidden', elevation: 3 },
  ...
  courseIcons: { flexDirection: 'row', position: 'absolute', top: 10, right: 10, gap: 10 },
